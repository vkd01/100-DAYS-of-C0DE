...
ml m;
loop(i,0,s.size()) m[s[i]]++;
bool flag = true;
ll lucky = 0;
for(auto i : m) {
    // if(i.first=='4') {
    //     if(i.ss=='4' || i.ss == '7') {print("YES") flag = false; return;}
    //     else {print("NO") flag = false; return;}
    // }
    // else if(i.first=='7') {
    //     if(i.ss=='4' || i.ss == '7') {print("YES") flag = false; return;}
    //     else {print("NO") flag = false; return;}
    // } 
  if(i.ff == '4') lucky+=(i.ss);
  else if(i.ff == '7') lucky+=(i.ss);
}

((lucky==4 || lucky==7) && lucky !=0) ? cout<<("YES")<<endl : print("NO")
